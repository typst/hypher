% This is a modified version of `cahyph.tex' for use with Typst's hypher. The
% `n` compatibility command has been removed and the ^^ notation has been
% resolved. We also removed non-pattern exceptions. The original file has been
% retrieved from
% https://ftp.uni-bayreuth.de/packages/TeX/languages/hyphenation/cahyph.tex on
% February 27, 2024. The modification has been made by Martin Haug on the same
% day.
%
